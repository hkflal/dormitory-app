            ...
            <div className="flex-1 grid grid-cols-7 gap-2 items-center">
                <div className="flex flex-col">
                    <span className="text-xs font-medium text-primary-600 truncate dark:text-primary-400">
                        ...
                        {invoice.renewal_tag && <span className="ml-1 text-xs text-cyan-600 bg-cyan-100 dark:bg-cyan-900 dark:text-cyan-300 px-1 py-0.5 rounded">自動生成</span>}
                    </span>
        ...
        <div className="p-4 sm:p-6 lg:p-8">
            <div className="sm:flex sm:items-center sm:justify-between mb-6">
                ...
                <div className="mt-4 sm:mt-0 sm:ml-16 sm:flex-none flex items-center space-x-2">
                    <button onClick={() => setShowAddModal(true)} className="bg-primary-600 text-white px-4 py-1 rounded-md shadow-sm hover:bg-primary-700 flex items-center focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-500">
                        <DocumentPlusIcon className="h-5 w-5 mr-2" />
                        新增發票
                    </button>
                    <div className="flex items-stretch">
                        <input type="text" value={ctrInput} onChange={(e) => setCtrInput(e.target.value)} placeholder="輸入合約號碼" className="block w-full border-gray-300 dark:border-gray-600 rounded-l-md shadow-sm focus:ring-primary-500 focus:border-primary-500 sm:text-sm dark:bg-gray-700 dark:text-white px-3 py-1" />
                        <button onClick={handleNavigateToDetail} className="bg-primary-600 text-white px-4 py-1 rounded-r-md shadow-sm hover:bg-primary-700 flex items-center focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-500 z-10">跳轉</button>
                    </div>
                </div>
            </div>
